...
DATA_ROOT = '/home/ccclr0302/autobahn-test/benchmark/results-v2/Scenario2-1'
...
class Ploter:
    ...
    def legend_name(system):
        system_mapping = {
            ...
            "S4-A6": "S4-A6, Cut Condition = 1, k = 3",
            "S4-A7": "S4-A7, Cut Condition = 4, k = 1",
            "S4-A8": "S4-A8, Cut Condition = 4, k = 3",
            "S4-A9": "S4-A9, Cut Condition = 6, k = 1",
            "S4-A10": "S4-A10, Cut Condition = 6, k = 3",
            "S4-A11": "S4-A11, Cut Condition = 8, k = 1",
            "S4-A12": "S4-A12, Cut Condition = 8, k = 3",
        }
