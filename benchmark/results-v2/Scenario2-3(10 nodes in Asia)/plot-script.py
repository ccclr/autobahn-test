...
DATA_ROOT = '/home/ccclr0302/autobahn-test/benchmark/results-v2/Scenario2-3'
...
class Ploter:
    ...
    def legend_name(system):
        system_mapping = {
            ...
            "S4-A7": "S4-A7, Cut Condition = 5, k = 1",
            "S4-A8": "S4-A8, Cut Condition = 6, k = 1",
            "S4-A9": "S4-A8, Cut Condition = 8, k = 1",
        }
