...
class Ploter:
    ...
    def legend_name(system):
        system_mapping = {
            "S2-A1": "S2-A1, Cut Condition = 1, k = 1",
            "S2-A2": "S2-A2, Cut Condition = 1, k = 3",
            "S2-A3": "S2-A3, Cut Condition = 4, k = 1",
            "S2-A4": "S2-A4, Cut Condition = 4, k = 3",
            "S2-A5": "S2-A5, Cut Condition = 8, k = 1",
            "S2-A6": "S2-A6, Cut Condition = 8, k = 3",
            "S2-A7": "S2-A7, Cut Condition = 6, k = 1",
            "S2-A8": "S2-A8, Cut Condition = 6, k = 3",
...
if __name__ == '__main__':
    ...
    all_systems = [
        ...
        'S2-A1', 'S2-A2', 'S2-A3', 'S2-A4','S2-A5','S2-A6','S2-A7', 'S2-A8',
