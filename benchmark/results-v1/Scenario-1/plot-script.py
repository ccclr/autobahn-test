...
DATA_ROOT = '/home/ccclr0302/autobahn-test/benchmark/results/Scenario-1'
...
class Ploter:
    ...
    def legend_name(system):
        system_mapping = {
            "S1-A1": "S1-A1, EFP=True, Fast_Path_Timeout=100ms, EOT=True",
            "S1-A2": "S1-A2, EFP=True, Fast_Path_Timeout=500ms, EOT=True",
            "S1-A3": "S1-A3, EFP=True, Fast_Path_Timeout=800ms, EOT=True",
            "S1-A4": "S1-A4, EFP=False, Fast_Path_Timeout=\, EOT=False",
            "S2-A1": "S2-A1, EFP=True, Fast_Path_Timeout=100ms, EOT=True",
            "S2-A2": "S2-A2, EFP=True, Fast_Path_Timeout=500ms, EOT=True",
            "S2-A3": "S2-A3, EFP=True, Fast_Path_Timeout=800ms, EOT=True",
            "S2-A4": "S2-A4, EFP=False, Fast_Path_Timeout=\, EOT=False",
            "S3-A1": "S3-A1, EFP=True, Fast_Path_Timeout=100ms, EOT=False",
            "S3-A2": "S3-A2, EFP=True, Fast_Path_Timeout=500ms, EOT=False",
            "S3-A3": "S3-A3, EFP=True, Fast_Path_Timeout=800ms, EOT=False",
            "S3-A4": "S3-A4, EFP=False, Fast_Path_Timeout=\, EOT=False",
        }
