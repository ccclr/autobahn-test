...
class InstanceManager:
    ...
    def _get_ami(self, client):
        # Canonical 官方 Ubuntu 20.04 LTS focal 镜像 Owner ID
        ...
        if not images:
            raise Exception("ERROR: No Ubuntu 20.04 AMI found in this region!")

        # Debug 打印选中的 AMI
        print(f"DEBUG: Selected AMI {images[0]['ImageId']} - {images[0]['Name']} - {images[0]['CreationDate']}")
